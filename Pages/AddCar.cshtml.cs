...
public class AddCarModel(ApplicationDbContext _context) : PageModel
{
    ...
    public async Task<IActionResult> OnPost(IFormFile imageFile)
    {
        ...
        _context.Vehicules.Add(new Vehicule { ModelId = id, Prix = Vehicule.Prix, Climatisation = (this.Climatisation == "Avec"), Couleur = Vehicule.Couleur, Immatriculation = Vehicule.Immatriculation, Photo = fileName });
